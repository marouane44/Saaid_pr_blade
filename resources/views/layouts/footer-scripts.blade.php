<!-- COMMON SCRIPTS -->
<script src="{{ URL::asset('https://code.jquery.com/jquery-2.2.4.min.js') }}"></script>
...
{{-- <script src="{{ URL::asset('assets/functions"') }}"></script> --}}
{{-- <script src="{{ URL::asset('assets/plugins/lll.js"') }}"></script> --}}
...
<script src="{{ URL::asset('assets/plugins/jquery.cookiebar.js') }}"></script>
<script src="{{ URL::asset('assets/plugins/lazy_load.js') }}"></script>
<script>
    'use strict';
    $.cookieBar({
        fixed: true
